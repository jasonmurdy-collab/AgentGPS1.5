                ...
                <Card>
                    ...
                    <div className="space-y-3">
                        {recruits.map(recruit => {
                            ...
                            return (
                                // Fix: Adjusted grid layout to be more responsive on smaller screens
                                <div key={recruit.id} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4 items-end p-3 border border-border rounded-lg bg-background/50">
